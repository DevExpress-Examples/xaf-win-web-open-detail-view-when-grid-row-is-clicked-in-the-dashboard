...
Namespace ShowDetailViewFromDashboard.Web
    ...
    Partial Public Class ShowDetailViewFromDashboardAspNetApplication
        ...
        End Function
        Private Sub ShowDetailViewFromDashboardAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles Me.DatabaseVersionMismatch
#If EASYTEST Then
            e.Updater.Update()
            e.Handled = True
#Else
...
#End If
        ...
        Private Sub InitializeComponent()
            ...
            Me.module4 = New ShowDetailViewFromDashboard.Module.Web.ShowDetailViewFromDashboardAspNetModule()
