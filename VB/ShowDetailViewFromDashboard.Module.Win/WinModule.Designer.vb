Namespace ShowDetailViewFromDashboard.Module.Win
    Partial Public Class ShowDetailViewFromDashboardWindowsFormsModule
        ''' <summary> 
        ...
        Private Sub InitializeComponent()
            ' 
            ' ShowDetailViewFromDashboardWindowsFormsModule
            ' 
            Me.RequiredModuleTypes.Add(GetType(ShowDetailViewFromDashboard.Module.ShowDetailViewFromDashboardModule))
